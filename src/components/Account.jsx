        ...
        <div className="acct-cont">
            ...
            <div className="details-row">
              <div>
                ...
                <div className="camera">
                    <IoCameraReverse className="camerar text-white text-[20px]"/>
                </div>
              </div>
              </div>
              <h2 className="text-[1.3rem] font-[500] pt-5">
                Victory Chimezie
              </h2>
              <p className="text-[#201f1fc4] text-[1rem] pt-1 mb-1">
                chimezievictory578@gmail.com
              </p>
              <span className="text-[13px] text-[#201f1fdb] font-semibold span">
          ...
          <div className="account-text">
            ...
            <div className="acct-row unique">
              ...
              <div className="uni">
                <p>
                  To update your password, please use our dedicated password
                  reset flow. This ensures your account remains secure during
